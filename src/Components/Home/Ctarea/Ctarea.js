...
import "./Ctarea.css";
import pic1 from "../../../images/android.png";
import pic2 from "../../../images/market1.png";
import pic3 from "../../../images/money.png";
const Ctarea = () => {
  return (
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="service-area row">
              ...
              <div className="col-md-4 col-lg-4 col-xl-4 col-12 col-xs-12 col-sm-12 mt-4">
                <div className="single-service-wrapper">
